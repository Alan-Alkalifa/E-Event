      ...
      <section className='space-x-6 flex'>
        ...
        {dropdownOpen && (
          <div className='absolute right-0 mt-12 py-2 w-48 bg-white rounded-lg shadow-xl border border-yellow-300'>
            ...
            <Link href="/myprofile">
              <button className='block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left'>My Profile</button>
            </Link>
            <Link href="/dashboardAdmin">
              <button className='block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left'>Dashboard</button>
            </Link>
          </div>
        )}
      </section>
